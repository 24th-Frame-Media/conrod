...
3. **Rigorous Verification**: Always validate code changes using workspace build and test tooling (e.g., `cargo check`, `cargo test`) before declaring a task complete.
