...
export type KnownVehicle = { plate: string; make?: string; model?: string; colour?: string; team?: string; race_number?: string; driver?: string; country?: string };
...
export type Page = 'Library' | 'Album' | 'Scan' | 'Review' | 'Train' | 'Known vehicles' | 'Settings';
